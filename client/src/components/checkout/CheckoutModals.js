...
const BeforeCheckoutMessage = () => {
    ...
    const message = t("currrently we deliver only in Bulgaria and only with cash on delivery payment");
...
export { OrderConfirmed, ConfirmOrder, BeforeCheckoutMessage }
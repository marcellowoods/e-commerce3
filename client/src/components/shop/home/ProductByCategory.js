    ...
    return (
        <div className="w-full max-w-sm mx-auto rounded-md shadow-md overflow-hidden">
            <div className="">
                ...
                <div className="float-right transform translate-y-3 translate-x-1">
                    <button onClick={(() => onAddClick(id))} className=" p-2 rounded-full  text-white mx-5 mb-4 hover:bg-blue-500 focus:outline-none focus:bg-blue-500">

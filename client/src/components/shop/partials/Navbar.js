            ...
            <div>
                ...
                <div  className="color-main-bg fixed top-0 w-full z-10">
                    <div className="container mx-auto px-6 py-4 flex items-center justify-between">
                        <div className="hidden w-full color-main-light md:flex md:items-center">
                            {/* className="h-5 w-5" */}
                        ...
                        <div className="w-full color-main-bold md:text-center text-2xl font-semibold">
                            Brand
                        </div>
                        <div className="flex items-center justify-end w-full">
                            <button onClick={cartModalOpen} className="color-main-light focus:outline-none mx-2">
                            ...
                            <div className="flex">
                                <button onClick={navberToggleOpen} type="button" className="color-main-light hover:text-gray-500 focus:outline-none focus:text-gray-500" aria-label="toggle menu">

            ...
            <div>
                ...
                <div  className="color-main fixed top-0 w-full z-10">
                    <div className="container mx-auto px-6 py-4 flex items-center justify-between">
                        ...
                        <div className="w-full color-main md:text-center text-2xl font-semibold">
                            Brand
                        </div>
                        <div className="flex items-center justify-end w-full">
                            <button onClick={cartModalOpen} className="color-main focus:outline-none mx-2">
                            ...
                            <div className="flex">
                                <button onClick={navberToggleOpen} type="button" className="color-main hover:text-gray-500 focus:outline-none focus:text-gray-500" aria-label="toggle menu">
                ...
                <div style={{paddingTop: '72px'}}>
                    <nav className={`${isMobileNavOpen() ? "" : "hidden"} sm:flex sm:justify-center sm:items-center `}>
                        ...
                        <div className="flex flex-col  sm:flex-row">
                            <a className="mt-3 color-main hover:underline sm:mx-3 sm:mt-0" href="#">Home</a>
                            <a className="mt-3 color-main hover:underline sm:mx-3 sm:mt-0" href="#">Shop</a>
                            <a className="mt-3 color-main hover:underline sm:mx-3 sm:mt-0" href="#">Categories</a>
                            <a className="mt-3 color-main hover:underline sm:mx-3 sm:mt-0" href="#">Contact</a>
                    ...
                    <div className="color-main relative py-5 max-w-xs md:max-w-lg mx-auto">
                        ...
                        <input className="color-main w-full border rounded-md pl-10 pr-4 py-2 focus:border-blue-500 focus:outline-none focus:shadow-outline" type="text" placeholder="Search">
                        </input>
                    </div>
                </div>
